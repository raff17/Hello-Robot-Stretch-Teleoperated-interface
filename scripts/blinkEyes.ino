...
#define PIN 3              // Arduino pin 6 to DIN of 8x32 matrix.
...
//  Serial.println(state_msg.data[0]);
//}
...
void loop() {
  ...
  while (Serial.available()){
    ...
    if(vert >= 6 && vert <=8 && horiz >= 6 && horiz <= 8 && Manip == false && emotion == "base"){
      if(i != j){
        manTomob();
        j = i;
      }
    ...
    else if(vert >= 9 && vert <= 11 && horiz >= 6 && horiz <= 8 && Manip == false && emotion == "base"){
      slightUpMo();
      currentExpression = 2;
    }
    else if(vert >= 12 && vert <= 14 && horiz >= 3 && horiz <= 11 && Manip == false && emotion == "base"){
      eyesUpMo();
      currentExpression = 3;
    } 
    else if(vert >= 3 && vert <= 5 && horiz >= 6 && horiz <= 8 && Manip == false && emotion == "base"){
      slightDownMo();
      currentExpression = 4;
    }
    else if(vert >= 0 && vert <= 2 && horiz >= 3 && horiz <= 11 && Manip == false && emotion == "base"){
      eyesDownMo();
      currentExpression = 5;
    } 
    else if(vert >= 3 && vert <= 11 && horiz >= 9 && horiz <= 11 && Manip == false && emotion == "base"){
      slightRightMo();
      currentExpression = 6;
    }    
    else if(vert >= 0 && vert <= 14 && horiz >= 12 && horiz <= 14 && Manip == false && emotion == "base"){
      eyesRightMo();
      currentExpression = 7;
    } 
    else if(vert >= 3 && vert <= 11 && horiz >= 3 && horiz <= 5 && Manip == false && emotion == "base"){
      slightLeftMo();
      currentExpression = 8; 
    }
    else if(vert >= 0 && vert <= 14 && horiz >= 0 && horiz <= 2 && Manip == false && emotion == "base"){
      eyesLeftMo();
      currentExpression = 9;    
    }

    else if(vert >= 6 && vert <=8 && horiz >= 6 && horiz <= 8 && Manip == true && emotion == "base"){
      if(i != j){
        mobToman();
        j = i;
      }
    ...
    else if(vert >= 9 && vert <= 11 && horiz >= 6 && horiz <= 8 && Manip == true && emotion == "base"){
      slightUpMa();
      currentExpression = 2;
    }
    else if(vert >= 12 && vert <= 14 && horiz >= 3 && horiz <= 11 && Manip == true && emotion == "base"){
      eyesUpMa();
      currentExpression = 3;
    } 
    else if(vert >= 3 && vert <= 5 && horiz >= 6 && horiz <= 8 && Manip == true && emotion == "base"){
      slightDownMa();
      currentExpression = 4;
    }
    else if(vert >= 0 && vert <= 2 && horiz >= 3 && horiz <= 11 && Manip == true && emotion == "base"){
      eyesDownMa();
      currentExpression = 5;
    } 
    else if(vert >= 3 && vert <= 11 && horiz >= 9 && horiz <= 11 && Manip == true && emotion == "base"){
      slightRightMa();
      currentExpression = 6;
    }    
    else if(vert >= 0 && vert <= 14 && horiz >= 12 && horiz <= 14 && Manip == true && emotion == "base"){
      eyesRightMa();
      currentExpression = 7;
    } 
    else if(vert >= 3 && vert <= 11 && horiz >= 3 && horiz <= 5 && Manip == true && emotion == "base"){
      slightLeftMa();
      currentExpression = 8; 
    }
    else if(vert >= 0 && vert <= 14 && horiz >= 0 && horiz <= 2 && Manip == true && emotion == "base"){
      eyesLeftMa();    
      currentExpression = 9;
    }
